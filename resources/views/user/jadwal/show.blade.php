    ...
    <div class="container mt-5">
        <div class="card shadow-sm rounded-4">
            <div class="card-body p-4">
                ...
                <form id="form-pemesanan" method="POST" action="{{ route('user.pemesanan.store', $pemesananId ?? '') }}"
                            ...
                            @foreach ($grouped as $row => $ks)
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="d-flex flex-wrap" style="gap:10px">
                                        @foreach ($ks as $kursi)
                                            <div>
                                                <input type="checkbox" class="btn-check" id="k{{ $kursi->id }}"
                                                    data-id="{{ $kursi->id }}" autocomplete="off"
                    ...
                    <div class="mt-3 px-3">
                        <div class="d-flex justify-content-center flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-2" style="font-size: 0.85rem;">
                                <span class="btn btn-sm btn-outline-primary p-0"
                                    style="width: 28px; height: 28px; border-radius: 6px;"></span>
                                <span>Tersedia</span>
                            </div>
                            <div class="d-flex align-items-center gap-2" style="font-size: 0.85rem;">
                            ...
                            <div class="d-flex align-items-center gap-2" style="font-size: 0.85rem;">
                                <span class="btn btn-sm btn-primary p-0"
                                    style="width: 28px; height: 28px; border-radius: 6px;"></span>
                                <span>Dipilih</span>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('user.jadwal.index') }}" class="btn btn-outline-secondary rounded-3 px-4">&larr;
                            Kembali</a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content rounded-4">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="buktiPembayaran" class="form-label fw-semibold">Upload Bukti Pembayaran
                                            <span class="text-danger">*</span></label>
                                        <input class="form-control" type="file" id="buktiPembayaran"
                                            name="bukti_pembayaran" accept="image/*">
                                        <div id="buktiError" class="text-danger mt-1" style="display:none;">Bukti pembayaran
                                            wajib diunggah.</div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="btn-submit-final" class="btn btn-success rounded-3">Kirim
                                        &amp; Bayar</button>
                                </div>
                            </div>
                        </div>
